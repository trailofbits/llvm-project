; !sensitive has to come back from bitcode on the same allocas it went in on.
...
; CHECK-NEXT: %key = alloca i64, align 8, !sensitive [[EMPTY:![0-9]+]]
; CHECK-NEXT: %scratch = alloca i64, align 8{{$}}
; CHECK-NEXT: %round_keys = alloca [176 x i8], align 16, !sensitive [[EMPTY]]
; CHECK-NEXT: ret void
define void @marked() {
...
; CHECK-NEXT: %nonce = alloca i64, align 8, !sensitive [[EMPTY]]
; CHECK-NEXT: ret void
