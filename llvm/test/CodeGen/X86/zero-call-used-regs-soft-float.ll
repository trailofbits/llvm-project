...
; RUN: llc < %s -mtriple=x86_64-unknown-linux-gnu -verify-machineinstrs -o /dev/null 2>&1 | count 0
...
; the x87 registers are cleared. Without SSE the XMM registers are reserved, so
; they are never requested and nothing is reported for them.
